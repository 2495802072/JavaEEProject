...
<%@ page import="Managers.UserManager,java.util.ArrayList,java.sql.SQLException" %>

<%
    String username = request.getParameter("username");
    String password = request.getParameter("password-already");
    if (username == null ) {
        username = "";
    }
    if (password == null ) {
    ...
    boolean isUsernameExists = (usernames != null) && usernames.contains(username);
%>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <form class="d-flex flex-column">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="InputUsername1" aria-describedby="UsernameHelpBlock"
                       autocomplete="off" @blur="usernameInputBlur" value="<%=username%>"><!-- 关闭了自动填充 -->
            ...
            <div class="mb-3">
                ...
                <input type="password" id="inputPassword1" class="form-control" aria-describedby="passwordHelpBlock"
                       autocomplete="off" @blur="passwordInputBlur" value="<%=password%>"> <!-- 关闭了自动填充 -->
            ...
            <div class="mb-3">
                ...
                <input type="password" id="inputPassword2" class="form-control" aria-describedby="passwordHelpBlock2"
                       autocomplete="off" @blur="passwordInputBlur2"> <!-- 关闭了自动填充 -->
